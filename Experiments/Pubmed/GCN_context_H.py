                                ...
                                for balanced_training in balanced_training_list:
                                    ...
                                    if not os.path.exists(training_log_dir):
                                        ...
                                        model = MPGLN(in_channels=data.x.shape[1],
                                                      ...
                                                      n_neurons_per_classifier=[n_neurons_per_classifier]*n_hidden_layers,
                                                      n_classifiers_per_layer=[n_classifiers_per_layer]*n_hidden_layers,
                                                      n_hidden_layers=n_hidden_layers,
                                        ...
                                        model.set_networks_optimizer(lr=lr,weight_decay=weight_decay,criterion=torch.nn.BCELoss(reduction='none'))
