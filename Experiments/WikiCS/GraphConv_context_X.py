...
if __name__ == '__main__':
    ...
    n_hidden_layers_list = [1, 2, 4]
    n_neurons_per_classifier_list = [2, 4, 16]
    n_classifiers_per_layer_list =[16,24]#1,2,8,
    n_prototypes_list = [2,  6]#4,

    lr_list = [0.1,  0.01, 0.001] #0.2,
