...
class LinearGatedProtoGCNConv(MessagePassing):
    ...
    def __init__(self, in_channels,
        ...
        self.linear_proj = LinearGatedProto(in_channels, out_channels, context_dim, n_prototypes,device)
    ...
    def set_prototypes(self, training_set,protopytes_indices=None, dim_test=True):
        ...
        self.linear_proj.set_prototypes(training_set[protopytes_indices],dim_test)
